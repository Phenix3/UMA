...
abstract class CrudController extends BaseController
{
    ...
    public function crudIndex(QueryBuilder $query = null): Response
    {
        ...
        $data['prefix'] = $this->routePrefix;

        return $this->render("admin/{$this->templatePath}/index.html.twig", array_merge($data, $this->vars));
    }
    ...
    public function crudEdit(CrudDataInterface $data): Response
    {
        ...
        return $this->renderForm("admin/{$this->templatePath}/edit.html.twig", [
            'form' => $form,
            'entity' => $data->getEntity(),
            'menu' => $this->menuItem,
        ]);
